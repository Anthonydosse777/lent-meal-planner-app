...
import { SupplementReminderModal } from "../../components/SupplementReminderModal";
...
export default function TabLayout() {
    ...
    const [supplementSettingsVisible, setSupplementSettingsVisible] = useState(false);
    ...
    return (
        <>
        <SupplementReminderModal />
        <SupplementSettingsModal
            visible={supplementSettingsVisible}
            onClose={() => setSupplementSettingsVisible(false)}
        />
        <Tabs
            screenOptions={{
                headerShown: true,
                ...
                headerRight: () => (
                    <View style={{ flexDirection: "row", alignItems: "center", marginRight: 16, gap: 10 }}>
                        ...
                        <TouchableOpacity
                            onPress={() => setSupplementSettingsVisible(true)}
                            hitSlop={8}
                            style={{
                                flexDirection: "row",
                                alignItems: "center",
                        ...
                        >
                            <MaterialCommunityIcons name="pill" size={14} color={C.textMuted} />
                            <Text style={{
                                color: C.textMuted,
                                fontSize: 11,
                                fontWeight: "700",

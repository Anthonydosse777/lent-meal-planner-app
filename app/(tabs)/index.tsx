...
import { generateExactPlan } from "../../lib/meal-logic";
...
export default function PlanScreen() {
    ...
    async function handleGenerate() {
        const { protein, strictness, mealsPerDay, mode } = config;
            ...
            >
                ...
                <View style={{ marginBottom: 28 }}>
                    ...
                    <Text style={{ color: C.textMuted, fontSize: 14, marginTop: 4 }}>
                        Configure your targets and generate a macro-exact plan.
                    </Text>
                </View>

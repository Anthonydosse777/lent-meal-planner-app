...
export const INGREDIENTS: Ingredient[] = [
    ...
    // Animal Proteins (unrestricted only)
    { id: "chicken_breast", name: "Chicken Breast", category: "poultry", nutritionPer100g: { calories: 165, protein: 31, carbs: 0, fiber: 0, fat: 3.6 }, defaultUnit: "oz", gramsPerUnit: 28, allowedIn: ["unrestricted"], priceLevel: "medium" },
    { id: "ground_turkey", name: "Lean Ground Turkey (93/7)", category: "poultry", nutritionPer100g: { calories: 176, protein: 27, carbs: 0, fiber: 0, fat: 7 }, defaultUnit: "oz", gramsPerUnit: 28, allowedIn: ["unrestricted"], priceLevel: "medium" },
    { id: "lean_beef", name: "Lean Beef (90/10)", category: "meat", nutritionPer100g: { calories: 217, protein: 26, carbs: 0, fiber: 0, fat: 12 }, defaultUnit: "oz", gramsPerUnit: 28, allowedIn: ["unrestricted"], priceLevel: "high" },
    { id: "eggs", name: "Eggs", category: "egg", nutritionPer100g: { calories: 155, protein: 13, carbs: 1.1, fiber: 0, fat: 11 }, defaultUnit: "large", gramsPerUnit: 50, allowedIn: ["unrestricted"], priceLevel: "low" },
    { id: "egg_whites", name: "Egg Whites", category: "egg", nutritionPer100g: { calories: 52, protein: 11, carbs: 0.7, fiber: 0, fat: 0.2 }, defaultUnit: "large", gramsPerUnit: 33, allowedIn: ["unrestricted"], priceLevel: "low" },
    { id: "greek_yogurt", name: "Nonfat Greek Yogurt", category: "dairy", nutritionPer100g: { calories: 59, protein: 10, carbs: 3.6, fiber: 0, fat: 0.4 }, defaultUnit: "cup", gramsPerUnit: 245, allowedIn: ["unrestricted"], priceLevel: "low" },
    { id: "cottage_cheese", name: "Low-Fat Cottage Cheese", category: "dairy", nutritionPer100g: { calories: 84, protein: 11, carbs: 4.3, fiber: 0, fat: 2.3 }, defaultUnit: "cup", gramsPerUnit: 226, allowedIn: ["unrestricted"], priceLevel: "low" },
    // Spices & Other
...
export const MEAL_TEMPLATES: MealTemplate[] = [
    ...
    {
        title: "Grilled Chicken & Rice Power Bowl",
        description: "Lean grilled chicken breast over rice with roasted broccoli — high protein, balanced macros.",
        ingredients: [
            { ingredientId: "chicken_breast", amount: 7, unit: "oz" },
            { ingredientId: "rice_white", amount: 1, unit: "cup" },
            { ingredientId: "broccoli", amount: 1.5, unit: "cup" },
            { ingredientId: "olive_oil", amount: 1, unit: "tbsp" },
            { ingredientId: "garlic", amount: 2, unit: "clove" },
            { ingredientId: "lemon", amount: 1, unit: "tbsp" },
        ],
        instructions: [
            "Season chicken with salt, pepper, garlic, and lemon, then grill or pan-sear until cooked through.",
            "Cook rice per package instructions.",
            "Roast or steam broccoli until tender-crisp.",
            "Slice chicken and serve over rice with broccoli, drizzled with olive oil.",
        ],
        prepTime: 10,
        cookTime: 20,
        tags: ["Unrestricted", "High Protein", "Macro Friendly", "Dinner"],
        imageKeyword: "grilled+chicken,rice+bowl",
    },
    {
        title: "Lean Beef & Veggie Stir-Fry",
        description: "Lean beef seared with peppers and onion over rice — protein-dense and macro-friendly.",
        ingredients: [
            { ingredientId: "lean_beef", amount: 6, unit: "oz" },
            { ingredientId: "bell_pepper", amount: 1, unit: "medium" },
            { ingredientId: "onion", amount: 1, unit: "medium" },
            { ingredientId: "broccoli", amount: 1, unit: "cup" },
            { ingredientId: "rice_white", amount: 1, unit: "cup" },
            { ingredientId: "garlic", amount: 2, unit: "clove" },
        ],
        instructions: [
            "Slice beef thin and stir-fry over high heat until browned.",
            "Add garlic, peppers, onion, and broccoli; stir-fry until crisp-tender.",
        ...
        cookTime: 15,
        tags: ["Unrestricted", "High Protein", "Macro Friendly", "Dinner"],
        imageKeyword: "beef+stir+fry,rice",
    },
    {
        title: "Chicken Shawarma Bowl",
        description: "Spiced chicken breast with veggies and tahini — a high-protein Middle Eastern bowl.",
        ingredients: [
            { ingredientId: "chicken_breast", amount: 7, unit: "oz" },
            { ingredientId: "tomato", amount: 1, unit: "medium" },
            { ingredientId: "cucumber", amount: 1, unit: "medium" },
        ...
        instructions: [
            "Toss chicken with cumin, salt, pepper, and a little oil; sear until cooked.",
            "Dice tomato, cucumber, and onion.",
            "Whisk tahini with lemon and a splash of water for sauce.",
            "Slice chicken and serve with veggies and pita, drizzled with tahini.",
        ],
        prepTime: 15,
        cookTime: 15,
        tags: ["Unrestricted", "High Protein", "Middle Eastern", "Macro Friendly"],
        imageKeyword: "chicken+shawarma,bowl",
    },
    {
        title: "High-Protein Egg Scramble",
        description: "Whole eggs and egg whites scrambled with spinach and tomato — quick, lean, macro-friendly.",
        ingredients: [
            { ingredientId: "eggs", amount: 3, unit: "large" },
            { ingredientId: "egg_whites", amount: 3, unit: "large" },
            { ingredientId: "spinach", amount: 2, unit: "cup" },
            { ingredientId: "tomato", amount: 1, unit: "medium" },
            { ingredientId: "olive_oil", amount: 0.5, unit: "tbsp" },
            { ingredientId: "pita_bread", amount: 1, unit: "piece" },
        ],
        instructions: [
            "Whisk whole eggs and egg whites together with salt and pepper.",
            "Saute spinach and diced tomato in olive oil until wilted.",
            "Pour in eggs and scramble over medium heat until just set.",
            "Serve with warm pita bread.",
        ],
        prepTime: 5,
        cookTime: 10,
        tags: ["Unrestricted", "High Protein", "Breakfast", "Quick"],
        imageKeyword: "egg+scramble,spinach",
    },
    {
        title: "Greek Yogurt Protein Bowl",
        description: "Thick Greek yogurt with oats, almonds, and flax — a high-protein macro-friendly breakfast.",
        ingredients: [
            { ingredientId: "greek_yogurt", amount: 1.5, unit: "cup" },
            { ingredientId: "oats", amount: 0.5, unit: "cup" },
            { ingredientId: "almonds", amount: 1, unit: "oz" },
            { ingredientId: "flax_seed", amount: 1, unit: "tbsp" },
            { ingredientId: "cinnamon", amount: 0.5, unit: "tsp" },
        ],
        instructions: [
            "Spoon Greek yogurt into a bowl.",
            "Top with oats, chopped almonds, and flax seed.",
            "Sprinkle with cinnamon and stir to combine.",
        ],
        prepTime: 5,
        cookTime: 0,
        tags: ["Unrestricted", "High Protein", "Breakfast", "No Cook"],
        imageKeyword: "greek+yogurt,protein+bowl",
    },
    {
        title: "Beef & Lentil Power Bowl",
        description: "Lean beef combined with lentils for a very high-protein, fiber-rich, macro-balanced bowl.",
        ingredients: [
            { ingredientId: "lean_beef", amount: 5, unit: "oz" },
            { ingredientId: "lentils_brown", amount: 1, unit: "cup" },
            { ingredientId: "onion", amount: 1, unit: "medium" },
            { ingredientId: "tomato", amount: 1, unit: "medium" },
            { ingredientId: "garlic", amount: 2, unit: "clove" },
        ...
        instructions: [
            "Brown lean beef with onion and garlic.",
            "Stir in cooked lentils, diced tomato, and cumin.",
            "Simmer 10 minutes, season with salt and pepper.",
            "Serve hot.",
        ],
        prepTime: 10,
        cookTime: 25,
        tags: ["Unrestricted", "High Protein", "High Fiber", "Macro Friendly"],
        imageKeyword: "beef+lentil,protein+bowl",
    },
];
